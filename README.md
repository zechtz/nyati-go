...
Prebuilt binaries for common platforms will be available in the Releases section (coming soon). Download the appropriate binary for your system, make it executable, and move it to your $PATH:
